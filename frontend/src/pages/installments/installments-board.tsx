...
type InstallmentStatus = "ACTIVE" | "COMPLETED" | "DEFAULTED";
            ...
            <div className="grid gap-4 xl:grid-cols-2">
                {installments.map((installment) => {
                    ...
                    return (
                        <article
                            key={installment.id}
                            className="overflow-hidden rounded-xl border border-border bg-background shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-md"
                        >
                            <div className="flex flex-col gap-4 border-b border-border bg-muted/30 p-4 sm:flex-row sm:items-start sm:justify-between">
                                <div className="min-w-0 space-y-2">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-sm text-muted-foreground">
                                            {installment.clientName} · {installment.comment}
                                        </p>
                                    </div>
                                </div>
