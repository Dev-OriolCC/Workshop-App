...
const initialMessages: WhatsAppMessage[] = [
    {
        ...
        text: "Hello, your installment plan is active. Please keep your next payment date in mind.",
    },
    {
        id: "MSG-1002",
        date: "2026-05-20T09:30:00",
        text: "Payment received. Your balance has been updated in our system.",
    },
];
